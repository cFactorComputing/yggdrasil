package io.swiftwallet.yggdrasil.adapters.sms.resetpassword.processors;
...
@Component
public class ResetPasswordSmsPreProcessor extends AbstractSmsAdapterPreProcessor {
    ...
    @Override
    protected void buildTemplateContext(Exchange exchange, Context context) {
