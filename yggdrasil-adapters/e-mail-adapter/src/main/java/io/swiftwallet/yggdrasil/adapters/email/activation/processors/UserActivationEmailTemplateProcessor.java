package io.swiftwallet.yggdrasil.adapters.email.activation.processors;
...
@Component
public class UserActivationEmailTemplateProcessor extends AbstractEmailTemplateProcessor {
