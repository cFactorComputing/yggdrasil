...
@ContextConfiguration(classes = {EmailTestConfiguration.class, UserLoyaltySubscriptionEmailTemplateProcessorTest.ContextConfig.class,
        OdinBootstrapConfiguration.class}, loader = CamelSpringDelegatingTestContextLoader.class)
